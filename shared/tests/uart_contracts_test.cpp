...
void TestInputPayloadValidation() {
    ...
    assert(UART_IS_VALID_INPUT_PAYLOAD(UART_CMD_INPUT_CONVEYOR_START, kSpeed100.data(), kSpeed100.size()) == 0U);
...
void TestSortingPayloadValidation() {
    ...
    assert(UART_IS_VALID_SORTING_PAYLOAD(UART_CMD_SORTING_CONVEYOR_START, kSpeed100.data(), kSpeed100.size()) == 0U);
    assert(UART_IS_VALID_SORTING_PAYLOAD(UART_CMD_SORTING_CONVEYOR_SET_SPEED, kSpeed100.data(), kSpeed100.size()) !=
           0U);
    assert(UART_IS_VALID_SORTING_PAYLOAD(UART_CMD_SORTING_CONVEYOR_SET_SPEED, kSpeed101.data(), kSpeed101.size()) ==
           0U);
