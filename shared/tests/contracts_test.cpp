...
void TestMqttTopicMessageValidation() {
    ...
    const auto destination_event =
        MakeMessage("MSG-TOPIC-06", mqtt::MessageType::kDestinationSet,
...
int main() {
    ...
    static_assert(mqtt::CommandResponseWatchdogTimeout(mqtt::ControlCommand::kStop, "PI-SORTING-01",
                                                       "sorting_conveyor") == std::chrono::seconds{ 17 });
