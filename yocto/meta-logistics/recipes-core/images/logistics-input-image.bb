SUMMARY = "Logistics input conveyor Raspberry Pi image"
DESCRIPTION = "Bootable Raspberry Pi image for the TLS-enabled input conveyor node"
LICENSE = "MIT"
