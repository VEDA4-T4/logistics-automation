SUMMARY = "Logistics line tracer Raspberry Pi node"
...
SRC_URI = " \
    ...
    file://linetracer-node.ini.example \
    file://logistics-linetracer-node.service \
"

SRCREV = "4d7003874f0547d91f320fdfb45c449699226b25"
...
do_install() {
    ...
    install -m 0600 \
        ${WORKDIR}/linetracer-node.ini.example \
