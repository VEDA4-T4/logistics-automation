...
## 작업 3: RECOVERY 완료를 SQLite와 MQTT에 원자 반영
...
## 작업 4: 모든 Pi 노드의 RECOVERY 초기화 계약 통일
...
## 작업 6: process epoch로 이전 MQTT 공정 차단
...
## 작업 9: 비전 작업 ID·바코드 상태 결합과 wall-clock 재시도
...
## 작업 10: 그리퍼 HOME 단일 완료 신호와 컨베이어 순서
