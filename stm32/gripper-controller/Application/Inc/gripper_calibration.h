...
/* Elbow-only first-stage range expansion. Keep other arm joints conservative. */
#define GRIPPER_ELBOW_SERVO_MIN_PULSE_US 750U
#define GRIPPER_ELBOW_SERVO_MAX_PULSE_US 2250U
