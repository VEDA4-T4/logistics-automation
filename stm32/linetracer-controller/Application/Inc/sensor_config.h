...
#define SENSOR_ULTRASONIC_STOP_DISTANCE_MM 50U
#define SENSOR_ULTRASONIC_CLEAR_DISTANCE_MM 70U
/* Compatibility names retained for existing sensor-logic tests and diagnostics. */
#define SENSOR_OBSTACLE_ON_MM SENSOR_ULTRASONIC_STOP_DISTANCE_MM
#define SENSOR_OBSTACLE_OFF_MM SENSOR_ULTRASONIC_CLEAR_DISTANCE_MM
...
/* Every direction can stop route motion; SensorTask enables ranging only while it is operationally required. */
...
#if (SENSOR_ULTRASONIC_STOP_DISTANCE_MM >= SENSOR_ULTRASONIC_CLEAR_DISTANCE_MM)
