...
#define LINETRACER_ROUTE_TEST_MODE 1U
#endif
...
#define SENSOR_OBSTACLE_CLEAR_SAMPLES 3U
#define SENSOR_ULTRASONIC_MAX_CONSECUTIVE_FAILURES 5U
#define SENSOR_ULTRASONIC_RECOVERY_SUCCESSES 3U
#define SENSOR_ULTRASONIC_ECHO_TIMEOUT_MS 40U
#define SENSOR_ULTRASONIC_STALE_MS 1500U
