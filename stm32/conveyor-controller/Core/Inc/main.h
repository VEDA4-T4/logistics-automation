...
#define SORTING_GATE_MG90S_PWM_Pin GPIO_PIN_7
#define SORTING_GATE_MG90S_PWM_GPIO_Port GPIOC
#define SORTING_GATE_SG90_PWM_Pin GPIO_PIN_8
#define SORTING_GATE_SG90_PWM_GPIO_Port GPIOC
